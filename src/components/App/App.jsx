...
import { getItems, addItem, deleteItem, updateUser, addCardLike, removeCardLike } from '../../utils/api'
      ...
      <CurrentTemperatureUnitContext.Provider value={{ currentTemperatureUnit, handleToggleSwitchChange }}>
        <div className='page'>
          ...
          <DeleteItemModal
            ...
            onDeleteClick={handleDeleteClick}
            onClose={onClose}
            onDeleteModalSubmit={(e) => handleDeleteItemModalSubmit(e, selectedCard._id, token)} />
        </div>
