export const weatherOptions = [
  ...
  },
  {
    day: true,
    condition: 'cloud',
    url: new URL('../images/day/cloud.png', import.meta.url).href,
  },
  {
    day: true,
    condition: 'rain',
  ...
  },
  {
    day: false,
    condition: 'cloud',
    url: new URL('../images/night/cloud.png', import.meta.url).href,
  },
  {
    day: false,
    condition: 'rain',
...
export const coordinates = {
  latitude: 41.034882,
  longitude: -111.938637
};

export const APIkey = 'c917aec702bc6a2870617975229469d7';